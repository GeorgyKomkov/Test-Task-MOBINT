  ...
  return (
    ...
    >
      <h2>
        {t('modal.removeTitle')}
        {' '}
        {card.activeCard.mobileAppDashboard.companyName}
        {' '}
        ?
        {' '}
      </h2>
      ...
      <div>
        <button type="button" className="modal-button modal-button-delete" onClick={hendleRemoveCard}>{t('modal.buttonRemove')}</button>
